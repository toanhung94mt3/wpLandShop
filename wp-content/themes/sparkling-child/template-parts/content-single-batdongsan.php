	...
	<div class="post-inner-content">
		<header class="entry-header page-header">
            ...
            <div class="left">
                ...
                <?php the_post_thumbnail( 'batdongsan_thumb' ); ?>
                <?php endif; ?>
            </div>
            <div class="right">
                <h1 class="entry-title "><?php the_title(); ?></h1>
                <div class="entry-cat"><?php the_taxonomies( $args ); ?></div>
                <div class="entry-price">Giá: <?php echo get_post_meta( $post->ID, 'batdongsan_price', true ); ?></div>
            </div>
            <!--/New code-->
		...
		<div class="entry-content">
            ...
            <div class="batdongsan_att">
                <?php $batdongsan_atts = get_post_meta($post->ID, 'batdongsan_attributes', false); ?>
                <table class="batdongsan_att_table">
                <?php
                foreach ($batdongsan_atts as $atts) {
                    foreach ($atts as $att) {?>
                        <tr class="batdongsan_att_table_row">
                            <th><?php echo $att['batdongsan_att_name']; ?></th>
                            <th><?php echo $att['batdongsan_att_value']; ?></th>
                        </tr>
                    <?php }
                }
                ?>

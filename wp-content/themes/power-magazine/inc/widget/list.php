...
function power_magazine_action_list() {

  register_widget( 'Power_magazine_List' );
  
}
add_action( 'widgets_init', 'power_magazine_action_list' );
class Power_magazine_List extends WP_Widget{ 

	function __construct() {
		global $control_ops;
		$widget_ops = array(
		  'classname'   => 'sport-section',
		  'description' => esc_html__( 'Add Widget to Display List Style Widget.', 'power-magazine' )
		);
		parent::__construct( 'power_magazine_list',esc_html__( 'PM: List Style', 'power-magazine' ), $widget_ops, $control_ops );
	}
